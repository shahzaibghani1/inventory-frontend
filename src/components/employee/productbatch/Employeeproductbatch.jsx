...
import Employeeaddbatch from './Employeeaddbatch';

function Employeeproductbatch(){
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/api/vi/employee/fetchbatches`, { headers });
  ...
  return (
    <div>
      ...
      {showCreateForm && <Employeeaddbatch onClose={handleCreateFormClose} />}
      <div>
        {isQRCodeModalOpen && (
...
export default Employeeproductbatch;